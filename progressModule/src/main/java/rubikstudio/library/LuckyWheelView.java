...
public class LuckyWheelView extends RelativeLayout implements PielView.PieRotateListener {
    ...
    private void init(Context ctx, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mSecondaryTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwSecondaryTextSize, (int) LuckyWheelUtils.convertDpToPixel(16f, getContext()));
    ...
    public void setStartAngle(float mStartAngle){
        pielView.setStartAngle(mStartAngle);
    }
}
